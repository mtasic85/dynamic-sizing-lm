...
A tool for upscaling and downscaling language models.
"""
...
def main():
    ...
    down_parser = subparsers.add_parser(
        "down", parents=[common_parser], help="Downscale a model using Folding method"
    )
    ...
    down_parser.add_argument(
        ...
        type=float,
        default=0.8,
        help="Compression ratio for downscaling (0.0-1.0, default: 0.8)",
    )
    down_parser.add_argument(
        "--device",
        default="auto",
        choices=["auto", "cuda", "cpu"],
        help="Device to use for downscaling (default: auto)",
    )
